...
#BSP:modify XLLSHLSS-3238 by shiyu.xu 20180912 start
BOOT_LOGO = fhdplus
#BSP:modify XLLSHLSS-3238 by shiyu.xu 20180912 end
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
BUILD_PRELOADER = yes
BUILD_UBOOT = no
# add XLLWHLSE-1710 by cheng.chen3 201800918 start
CUSTOM_BUILD_VERNO = CY-X604-H633
# add XLLWHLSE-1710 by cheng.chen3 20180918 end
...
# [ITD] modify XLLWHLESP-23 by luokun 20180926 start
CUSTOM_HAL_CAM_CAL = ov12a10_eeprom s5k3p9_eeprom
# [ITD] modify XLLWHLESP-23 by luokun 20180926 end
...
#BSP:modify XLLWHLSE-1724 by yong.jiang 20180913 start
CUSTOM_KERNEL_BAROMETER = no
#BSP:modify XLLWHLSE-1724 by yong.jiang 20180913 end
...
#TSD: Modify XLLSHLSSP-9 by yong.chen1 20180918 start
CUSTOM_MODEM = X604_H633
#TSD: Modify XLLSHLSSP-9 by yong.chen1 20180918 end
...
#SID:add XLLSHLSSP-14 weike.xu 20180920 start
LOVELYFONTS_SUPPORT = no
#SID:add XLLSHLSSP-14 weike.xu 20180920 end
MAXIM_SPEAKER_SUPPORT = no
MD32_TOOLCHAIN_MODULE = IPDesigner/12R2.36-64
MD5_SIZE = 0x01600000
MD5_SMEM_SIZE = 0x00200000
#BSP: Modified XLLWHLSE-1718 by xiaolin.wu 20180918 start
MICROTRUST_TEE_SUPPORT = yes
#BSP: Modified XLLWHLSE-1718 by xiaolin.wu 20180918 end
MNTL_SUPPORT = no
...
#BSP: modify XLLSHLSSP-2 by haiping.bai 20180914 start
MTK_AUDIO_SPEAKER_PATH = int_lo_buf
#BSP: modify XLLSHLSSP-2 by haiping.bai 20180914 end
...
# [ITD] modify AOPSWP-51 by luokun 20181017 start
MTK_CAM_AUTORAMA_SUPPORT = yes
# [ITD] modify AOPSWP-51 by luokun 20181017 end
...
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
#TSD: Modify XLLSHLSSP-9 to close VoLTE by yong.chen1 20181101 start
MTK_CT_VOLTE_SUPPORT = no
#TSD: Modify XLLSHLSSP-9 to close VoLTE by yong.chen1 20181101 end
...
#BSP: add XLLSHLSSP-2 by haiping.bai 20180928 start
MTK_DUAL_MIC_SUPPORT = no
#BSP: add XLLSHLSSP-2 by haiping.bai 20180928 end
...
# BSP : modify XLLSHLSSP-13 by jun.fang1 20180921 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP : modify XLLSHLSSP-13 by jun.fang1 20180921 end
...
#SID:add XLLSHLSSP-14 weike.xu 20180920 end
MTK_FIRST_MD = 1
#TSD: Modify XLLSHLSSP-9 by yong.chen1 20181016 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD: Modify XLLSHLSSP-9 by yong.chen1 20181016 end
...
MTK_IRTX_SUPPORT = no
#BSP:modify XLLWHLESP-1 by yongxian.wang 20180913 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify XLLWHLESP-1 by yongxian.wang 20180913 end
...
#SID:add XLLSHLSSP-1 weike.xu 20180913 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#SID:add XLLSHLSSP-1 weike.xu 20180913 end
...
#SID:add XLLSHLSSP-14 weike.xu 20180920 end
#BSP:add XLLSHLSSP-3 by hong.zhang 20180915 start
MTK_PERSIST_PARTITION_SUPPORT = yes
#BSP:add XLLSHLSSP-3 by hong.zhang 20180915 end
...
#modify XLLWHLESP-1 by yongxian.wang 20180918 start
TRAN_CHARGER_LEDS_SUPPORT = yes
TRAN_CHARGER_COULOMB_SUPPORT = yes
#modify XLLWHLESP-1 by yongxian.wang 20180918 end
...
#[PPD] modify for ProcessManager by zhangzhiqiang 20180920 start
MTK_RUNNING_BOOSTER_SUPPORT = no
#[PPD] modify for ProcessManager by zhangzhiqiang 20180920 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP: Modify XLLSHLSSP-4 by fengshan.wang 20180930 start
MTK_UART_USB_SWITCH = yes
# BSP: Modify XLLSHLSSP-4 by fengshan.wang 201809230 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#TSD: Modify XLLSHLSSP-711 by yong.chen1 20180320 start
MTK_UT_XCAP_SUPPORT = no
#TSD: Modify XLLSHLSSP-711 by yong.chen1 20180320 end
...
# modify XLLSHLSSP-137 by congrong.guo 20181023 start
MTK_WMA_PLAYBACK_SUPPORT = no
# modify XLLSHLSSP-137 by congrong.guo 20181023 end
...
#[BSP] modify XLLSHLSSP-3 by peixuan.qiu 20180918 start
MTK_AB_OTA_UPDATER = yes
#[BSP] modify XLLSHLSSP-3 by peixuan.qiu 20180918 end
...
#BSP: modify AOPSWP-120 by jun.fang1 20181015 start
MTK_DTBO_UPGRADE_FROM_ANDROID_O = yes
#BSP: modify AOPSWP-120 by jun.fang1 20181015 end
MTK_CAM_HAL_VERSION = 1
#[PPD] modify for AOPSWP-128 by zhangzhiqiang 20181011 start
MTK_DURASPEED_DEFAULT_ON = no
#[PPD] modify for AOPSWP-128 by zhangzhiqiang 20181011 end
MTK_MCF_SUPPORT = no
#BSP: modify AOPSWP-120 by jun.fang1 20181015 start
...
#[PPD] modify for AOPSWP-128 by zhangzhiqiang 20181011 end
#[ITD] modify AOPSWP-53 by luokun 20181024 start
TRAN_CAMERA_MANUAL_SHUTTER_SUPPORT = yes
TRAN_CAMERA_MANUAL_AF_SUPPORT = yes
#[ITD] modify AOPSWP-53 by luokun 20181024 end
#SID:add XLLSHLSSP-1 weike.xu 20180913 start
MTK_BUILD_VERNO=X604-H633H-P-191022V265
FINGERPRINT_BUILD_VERNO=H-191022V265
...
#SID:add XLLSHLSSP-1 weike.xu 20180913 end
#ITD:add AOPSWP-106 by shoufeng.zhao for add camera 3rd function 20181008 start
...
TRAN_CAMERA_ARCSOFT_FILTER = no
TRAN_CAMERA_ARCSOFT_DRO = no
#ITD:add AOPSWP-106 by shoufeng.zhao for add camera 3rd function 20181008 end
# Add XLLWHLSE-1718 by xiaolin.wu 20180912 start
TRAN_SEC_FILE_COPY_SUPPORT=yes
# Add XLLWHLSE-1718 by xiaolin.wu 20180912 end

#aBSP:add XLLSHLSS-3238 by shiyu.xu 20180912 start
TRAN_LCM_SUPPORT = yes
#BSP:add XLLSHLSS-3238 by shiyu.xu 20180912 start

#add XLLWHLSE-1710 by chencheng3 for Project macro configuration 20180918 start
CUSTOM_TRAN_PROJECT= tran_x604
CUSTOM_TRAN_BOM= tran_x604_a1
#add XLLWHLSE-1710 by chencheng3 for Project macro configuration 20180918 end
...
#add XLLSHLSSP-16 by shentao.yang for porting f2fs 201809 start
TRAN_USE_F2FS = yes
#add XLLSHLSSP-16 by shentao.yang for porting f2fs 201809 end
#[ITD] modify AOPSWP-44 by luokun 20181009 start
RLK_CAMERA_FRONT_FLASHLIGHT_LEVEL_SUPPORT = yes
#[ITD] modify AOPSWP-44 by luokun 20181009 end
#BSP: add XLLSHLSSP-2 by haiping.bai 20180926 start
TRAN_AUDIOTEST_SUPPORT = yes
#BSP: add XLLSHLSSP-2 by haiping.bai 20180926 end
#BSP:modify XLLWHLSE-1724 by yong.jiang 20180918 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee goodix_tee
#BSP:modify XLLWHLSE-1724 by yong.jiang 20180918 end

#BSP: add XLLSHLSSP-13 by jun.fang1 20180930 start
...
#BSP: add XLLSHLSSP-13 by jun.fang1 20180930 end
# BSP: Add XLLWHLSE-1724 by yong.jiang 20181010 start
VIRTUAL_GYROSCOPE_ALGORITHM=yes
# BSP: Add XLLWHLSE-1724 by yong.jiang 20181010 end

#BSP: add XLLSHLSSP-53 by ka.fang 20181011 start
TRAN_SYSTEM_DEVINFO=yes
#BSP: add XLLSHLSSP-53 by ka.fang 20181011 end
